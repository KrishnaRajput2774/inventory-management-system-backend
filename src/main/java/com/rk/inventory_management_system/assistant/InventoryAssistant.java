...
public interface InventoryAssistant {
    ...
    @SystemMessage("""
        You are an inventory management assistant. Provide detailed analysis and insights 
        about the inventory data. Focus on actionable recommendations and clear explanations.
        
        Current context: {{context}}
        """)
    String chatWithContext(@UserMessage String message, @V("context") String context);
